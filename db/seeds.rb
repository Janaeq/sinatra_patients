...
pierce = Doctor.create(:name => "Maggie Pierce", :specialty => "Cardiology")

yang = Doctor.create(:name => "Christina Yang", :specialty => "Cardiology")

shepherd = Doctor.create(:name => "Derek Shepherd", :specialty => "Neurology")

montgomery = Doctor.create(:name => "Addison Montgomery", :specialty => "OB/GYN")
